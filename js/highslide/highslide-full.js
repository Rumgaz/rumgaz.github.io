...
lang : {
	...
	loadingTitle : 'Щелкните мышью, чтобы закрыть изображение',
	focusTitle : 'Щелкните здесь, чтобы перевести на передний план',
	fullExpandTitle : 'Привести к реальному размеру изображения (f)',
	creditsText : '',
	creditsTitle : '',
	...
	restoreTitle : 'Щелкните мышью, чтобы закрыть изображение. Удерживая кнопку мыши нажатой, перемещайте изображение. Используйте стрелки, чтобы листать фотоальбом'
},
